...
SUBROUTINE SetThisVersionVariables()
      VerString='Conversion 9.5 => 9.5 DX coil'
      VersionNum=9.6
      sVersionNum='9.6'
...
!                 CurArgs = CurArgs + 1
              ...
              CASE('AIRLOOPHVAC:UNITARYSYSTEM')
                ...
                IF ( SameString( CoolingCoilType, "Coil:Cooling:DX:HeatExchangerAssisted" ) ) THEN
                  ! do nothing
                ELSE IF ( SameString( CoolingCoilType, "Coil:Cooling:DX:SingleSpeed:ThermalStorage" ) ) THEN
                  ! do nothing
             ...
             ! No transition required because this object only uses coil names, no coil object types
             ...
             CASE('COIL:COOLING:DX:SINGLESPEED')
                 ...
                 IF ( TempArgs(20) == Blank ) THEN
                   OutArgs(6)=TRIM(TempArgs(1)) // TRIM(' Condenser Inlet Node') ! Condenser Inlet Node Name
                 ELSE
                 ...
                 OutArgs(6)='Discrete' ! Capacity Control Method
             ...
             CASE('COIL:COOLING:DX:TWOSPEED')
              ...
              CASE('COIL:COOLING:DX:VARIABLESPEED')
                  ...
                  !OutArgs(5)='' ! Unit Internal Static Air Pressure - Only defined for Coil:Cooling:DX:TwoSpeed previously
                  OutArgs(6)='Continuous' ! Capacity Control Method
